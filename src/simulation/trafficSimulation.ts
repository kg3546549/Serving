...
export const SYSTEM_CATALOG: Readonly<
  ...
  >
> = {
  ec2: { name: "EC2 App Server", description: "표준적인 성능과 처리 균형을 제공하는 범용 앱 서버입니다.", cost: 4, tier: 1, category: "server", unlockWave: 1, nodeId: "serverA" },
  apache: { name: "Apache Web Server", description: "단순 요청을 매우 빠르게(속도 +45%) 처리하지만 큐 용량(-2)이 작습니다.", cost: 4, tier: 1, category: "server", unlockWave: 1, nodeId: "serverB" },
  ...
  sqs: { name: "SQS Message Queue", description: "서버에 대규모 큐(큐 용량 +10)를 추가해 폭주 트래픽을 안전하게 버퍼링합니다.", cost: 4, tier: 1, category: "queue", unlockWave: 1 },
  eks: { name: "EKS Container Node", description: "컨테이너 기반 고성능 서버입니다. 동시 처리량(+4), 큐(+3), 속도(+20%)가 크게 상승합니다.", cost: 12, tier: 2, category: "server", unlockWave: 1, nodeId: "serverA" },
  ...
  cognito: { name: "Cognito Auth Server", description: "사용자 인증과 권한 검증을 처리하는 보안 모듈입니다.", cost: 12, tier: 2, category: "security", unlockWave: 1 },
  rdsReplica: { name: "RDS Read Replica", description: "DB 읽기 복제본 모듈입니다. DB 동시 처리량(+2)과 속도(+25%)를 올립니다.", cost: 25, tier: 3, category: "database", unlockWave: 1 },
  redis: { name: "ElastiCache Redis", description: "자주 조회되는 데이터를 캐싱하여 DB 처리 시간 배수를 크게 단축(속도 +35%)시킵니다.", cost: 25, tier: 3, category: "cache", unlockWave: 1 },
  ...
  waf: { name: "AWS WAF", description: "악성 웹 요청을 서버 진입 전에 감지하고 차단하는 방화벽 모듈입니다.", cost: 25, tier: 3, category: "security", unlockWave: 1 },
  lambda: { name: "Lambda Serverless", description: "서버리스 동적인 확장형 함수입니다. 높은 동시성(+8)을 가지지만 미세한 지연(+20%)이 발생합니다.", cost: 50, tier: 4, category: "server", unlockWave: 1, nodeId: "serverA" },
  ecs: { name: "ECS Batch Worker", description: "대용량 비동기 작업을 처리합니다. 매우 큰 큐 용량(+8)을 갖지만 처리 시간(+35%)이 소요됩니다.", cost: 50, tier: 4, category: "server", unlockWave: 1, nodeId: "serverB" },
  documentDb: { name: "DocumentDB", description: "분산 NoSQL 모듈입니다. DB 동시 처리량(+2)과 속도(+25%)를 향상시킵니다.", cost: 50, tier: 4, category: "database", unlockWave: 1, nodeId: "database" },
  kafka: { name: "MSK Kafka", description: "이벤트 스트림 대용량 큐 모듈입니다. 서버 큐(+12) 및 DB 큐(+6)를 대폭 확장합니다.", cost: 50, tier: 4, category: "queue", unlockWave: 1 },
  dynamoDb: { name: "DynamoDB", description: "글로벌 규모의 NoSQL 요청을 처리합니다.", cost: 90, tier: 5, category: "database", unlockWave: 1, nodeId: "database" },
  s3: { name: "S3 Object Storage", description: "대용량 콘텐츠를 보관하는 스토리지 모듈로, DB 큐 용량(+6)을 추가 확보합니다.", cost: 90, tier: 5, category: "storage", unlockWave: 1 },
